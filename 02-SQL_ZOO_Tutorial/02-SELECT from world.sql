...
/*
1.Read the notes about this table. Observe the result of running this SQL command to show the 
...
/*
2.How to use WHERE to filter records. Show the name for the countries that have a population of
...
count because they have more than one word in the name.
