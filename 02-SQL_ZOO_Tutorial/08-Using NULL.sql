...
/*
5.Use COALESCE to print the mobile number. Use the number '07986 444 2266' if there 
...
/*
6.Use the COALESCE function and a LEFT JOIN to print the teacher name and department
