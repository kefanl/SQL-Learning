/*ALL DESCRIPTION OF QUESTIONS ARE COPIED FROM https://sqlzoo.net/wiki/SQL_Tutorial*/

/*
1.The first example shows the goal scored by a player with the last name 'Bender'. The * says to list all the columns in the 
...
Notice in the that the column matchid in the goal table corresponds to the id column in the game table. We can look up information about game 
...
*/
SELECT stadium, COUNT(player) AS sum_goal
